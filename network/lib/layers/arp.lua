...
---@return ARPFrame
setmetatable(ARPFrame, {__call = function(self, htype, ptype, oper, sha, spa, tha, tpa)
...
---@return ARPLayer
setmetatable(ARPLayer, {__call = function(self, osiLayer)
    local o = {
        _layer = osiLayer
    }
    setmetatable(o, {__index = self})
...
function arp.getAddress(interface, htype, ptype, pa, spa)
    ...
    local tpa = select(4, event.pull(2, "arp", htype, ptype, nil, pa))
    return tpa
end
