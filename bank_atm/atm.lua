...
local function init()
  ...
  local label_withdraw = gui.widget.Text(4, 6, 7, 1, 0xffffff, "RETIRER")
  ...
  local label_deposit = gui.widget.Text(4, 9, 7, 1, 0xffffff, "DEPOSER")
  ...
  local label_eject = gui.widget.Text(4, 12, 6, 1, 0xffffff, "QUITER")
